...
- One Codex task owns one coherent outcome. Start a new task when the outcome, branch, deliverable, or major module changes. Keep durable facts in code, tests, Git, `AGENTS.md`, and concise project docs, not old chat transcripts.
