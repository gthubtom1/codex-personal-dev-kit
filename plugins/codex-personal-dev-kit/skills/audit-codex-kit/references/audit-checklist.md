...
- 七个 standalone Skill（一个入口、六个内部能力）通过官方 validator；仓库不要求 Plugin manifest。
...
- standalone Dev Kit 不注册替代代理的 MCP/App，母文件夹和项目配置保持原生 multi-agent 开启并固定 `gpt-5.6-luna/max`。
